const { UI } = PDFAnnotate;
    const documentId = '/static/annotate1/example.pdf';
    let PAGE_HEIGHT;
    let RENDER_OPTIONS = {
        documentId,
        pdfDocument: null,
    ...
    PDFJS.workerSrc = '/static/annotate1/shared/pdf.worker.js';
    ...
    (function (window, document) {
        ...
        function insertComment(comment) {
            ...
            child.innerHTML = twttr.autoLink(twttr.htmlEscape(comment.content));
