...
THEME = 'wisedome_theme'

SECRET = 'foobar'
SECRET_KEY = 'my-session-secret'

SQLALCHEMY_DATABASE_URI = 'postgresql://py_user:1234@urd.nlp.wo.tc:7000/pybossa'
...
FACEBOOK_APP_ID='675087629969166'
FACEBOOK_APP_SECRET='8a366a17332afbdaacdb121fea32ed0c'
GOOGLE_CLIENT_ID='974351029335-0oj26mhp9i2cq4k27m37psfdtr3cjnqc.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET='6kx6Zp-ATuTjpSd2pPb3CO_y'

## Supported Languages
## NOTE: You need to create a symbolic link to the translations folder, otherwise
## this wont work.
## ln -s pybossa/themes/new_theme/translations pybossa/translations
DEFAULT_LOCALE = 'ko'
...
STATS_FRONTPAGE_TIMEOUT = 1 * 10
STATS_APP_TIMEOUT = 1 * 10
STATS_DRAFT_TIMEOUT = 1 * 10
N_APPS_PER_CATEGORY_TIMEOUT = 1 * 60
BROWSE_TASKS_TIMEOUT = 1 * 60
# Category cache
CATEGORY_TIMEOUT = 1 * 60
# User cache
USER_TIMEOUT = 15 * 60
...
#LEADERBOARDS = [nowDate, 'point_sum']
